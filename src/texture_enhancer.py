...
class TextureEnhancer:
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            logger.info("Note: ISR is a fallback option. For best quality with Python 3.10+, install Real-ESRGAN with: pip install realesrgan==0.3.0 basicsr==1.4.2 facexlib==0.3.0 gfpgan==1.3.8")
            ...
            logger.error(
                ...
                "Install either:\n"
                "  1. Real-ESRGAN (RECOMMENDED for Python 3.10+): pip install realesrgan==0.3.0 basicsr==1.4.2 facexlib==0.3.0 gfpgan==1.3.8\n"
                "  2. ISR (only for Python 3.7-3.9): pip install ISR==2.2.0\n"
